class ProductsController < ApplicationController
 ...
 def update
  ...
  def product_params
    params.require(:product).permit(:title, :size, :facebook, :instagram, :youtube, :twitter, :price, :price_ht, :expedition_costs, :category_id, :website, :size_guide, :video_url, :description, photos: [])
  end
