...
ActiveRecord::Schema.define(version: 2018_11_23_144857) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.index ["pick_id"], name: "index_orders_on_pick_id"
    t.index ["pro_id"], name: "index_orders_on_pro_id"
  end
  ...
  create_table "picks", force: :cascade do |t|
    ...
    t.jsonb "transac_detail", default: {}
  ...
  add_foreign_key "orders", "picks"
  add_foreign_key "orders", "pros"
